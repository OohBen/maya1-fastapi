# Volume 6, Chapter 7 — *Whole*

**Source:** ch19:5–208. The chapter begins the instant after Chapter 6's reverse summons lands him in
...
his armour and forehead protector," which is only consistent if he wore both all day. This chapter
therefore locks: **armour is worn with the forehead protector; the plain black attire of Chapters 1–3
is worn without it.** Chapters 8 and 9 inherit that rule and Chapter 9 strips both on page 5.

## Source effect

Naruto keeps a promise, and the reader watches him pay for it in a currency he did not expect to
spend. Kurama gets his other half back and refuses to say thank you; the only warmth in the scene is
Naruto giving him his name, which is worth more than gratitude and which neither of them
acknowledges. Then the man who caused everything is stood up on a rock and allowed to speak, and the
chapter's real work happens in Naruto's face rather than in his mouth: the hatred that has organised
his life since he was seven does not survive contact with the actual account, and nothing replaces
it. He does not forgive Minato. He does not call him father. He also cannot hate him cleanly any
more, and both of those must be legible.

The two things he says that he has never said aloud — that he intends to be Rokudaime, and that
Minato will go to Kushina rather than back into the Shinigami — are gifts he gives without admitting
they are gifts. Minato's answer is the one thing in the chapter Naruto does not have a counter for,
and he says nothing at all. The reader must not be told what he felt.

The coda restates the cost as a joke Kurama does not find funny: the beast is denied his revenge
twice in three minutes, once on Minato and once on Obito, and the second refusal is not mercy. It is
ownership.

## Continuity in

- Continuous with Chapter 6. Naruto reverse-summoned out of his own bedroom seconds ago; Yugao has
  just kissed his cheek and told him she will see him tonight. It is still morning and he must be
...
- Kurama is physically free, lives in Dragon Land, and is **half complete** — Naruto promised the
  other half in Volume 5 and has not delivered it until this chapter.
- Zetsu left ahead of Naruto and is already in Dragon Land. Naruto cannot sense him.
- Naruto has the Edo Tensei from Orochimaru's scrolls. He has used it once before, on Kushina, and
  intends never to use it again after today.
- Danzō is crippled and alive; Root is destroyed; Yugao and Karin were rescued by Zetsu wearing
  Naruto's form and Yugao believes Naruto did it.
- Naruto knows Obito is the masked man of the sealing night and intends to kill him personally. He
  learned this from Madara, not from Minato, and nothing in this chapter teaches it to him.

## Dramatic scene script

| Scene | Objective | Obstacle | Tactic | Turn | Decision | Consequence | Handoff |
|---|---|---|---|---|---|---|---|
| 1. The walk (pp. 1–3) | Zetsu wants to know whether the two women have become a problem Naruto cannot manage. | Naruto does not accept that they are a problem, and will not be drawn on what he would have done if they were. | Zetsu argues from observation — this is how women behave — and Naruto answers with training and biography instead. | Zetsu changes target: Karin is not ANBU and is not even a shinobi. | Naruto answers with four words and then refuses the hypothetical entirely, with a shrug. | The reader learns that Naruto's confidence in people is an assessment of their conditioning, not affection. | They reach the basin and the eye opens. |
| 2. The promise (pp. 4–6) | Naruto wants to discharge a debt so that it stops being outstanding. | Kurama has been promised things by humans before and has no reason to expect delivery. | State the date, not the method. Let the beast ask how. | Kurama searches his face for the lie and does not find one. | Naruto performs the Edo Tensei rather than explaining it — the answer to "how" is a coffin. | Kurama learns Naruto keeps promises. Minato learns he has no say in anything. | Minato is animated and immediately silenced. |
| 3. Whole (pp. 7–10) | Kurama wants the half of himself the Yondaime took. | The only person who can return it is the man he most wants to kill, and he cannot be allowed to be killed first. | Naruto removes Minato's personality so the transfer happens without argument. | Kurama's thanks is a paw strike, which tells the reader exactly how much the restoration cost him emotionally: nothing. | Naruto gives him his name instead of asking for gratitude. | Kurama is whole, is called Kurama by a human for the second time in his existence, and refuses to acknowledge it. | Naruto goes after Minato alone; Zetsu declines to watch. |
| 4. The bench (pp. 11–16) | Naruto wants the account, complete, from the man himself — not because he needs it, but because it is the only unresolved item left. | Minato wants to be forgiven and cannot ask for it. | Naruto builds two benches so that the man must sit opposite him and be looked at, opens with Kushina to establish he owes this to her and not to Minato, and then does not interrupt once. | The account contains no villain except a masked man. The plan was survivable; the plan simply failed. | Naruto lets him finish. | The clean hatred cannot survive the detail. Nothing arrives to replace it. | Naruto states the arithmetic back to him. |
| 5. The reckoning (pp. 16–19) | Minato wants to be told his son is all right. | Naruto will not lie to him and will not comfort him. | Naruto lists what actually happened to each of the four adults Minato trusted, then tells him about the hatred as a completed historical fact. | "Whatever happened, happened" — the sentence that ends the case without dismissing it. | Naruto tells him he will be Hokage, and tells him where he is going when released. | Minato answers with love and does not reach for him. Naruto has no counter and gives none. | The release. Ash off a rise, and two empty benches. |
| 6. Denied twice (p. 20) | Kurama wants somebody to tear apart. | Both candidates are reserved. | He asks for Minato, then for the masked one. | Naruto answers the first with logic and the second with possession. | Kurama is refused twice inside three minutes. | The reader is reminded whose story this is and that the beast is not a pet. | Chapter 8 opens in the council chamber at ch19:209, an hour later. |
...
panels (the bench). Every PLATE panel carries a soft grey-washed border with no hard black gutter
line; every PRESENT panel carries the ordinary hard border. Minato's narration inside a PLATE is a
**tail-less oval balloon whose speaker is Minato**; he is not drawn in those panels and the balloon
must never grow a tail toward anyone inside the plate. The last plate's border frays away to white on
page 16 panel 3, which is how the reader is told the account is over.

### Spread 1 — pages 1–2: two women who did not break

**Source anchor:** ch19:5–29.

**Spread focal panel:** page 2, panel 1 — the two of them small and walking across a landscape that
has no village in it anywhere.

#### Page 1 — 4 panels

**Purpose:** Place the chapter marker, establish Dragon Land as somewhere with no human scale in it,
and let Zetsu open the chapter with an observation rather than a report.

1. **Right strip, x=60–100 y=0–100; extreme-wide vertical, high angle.** Cast/blocking: a red-lit
   plateau of broken stone shelves stepping away to a horizon of bare spires; dry grass in the
   cracks; a weathered ribcage of something enormous half-buried at mid-frame. Naruto stands very
   small at the lower third, back three-quarters to the reader, facing left, the last of a summoning
   smoke-ring still dispersing around his boots. Protect x=64–96 y=4–30 as flat dark sky: no figure,
   rock, effect, or balloon may enter this lettering-safe negative space. **TITLE1** centred in that
   protected area: "CHAPTER 7 — WHOLE". Tail-less chapter marker. **CAP1** lower right of the
   protected band, tail-less location card, small box: "DRAGON LAND".
2. **Top left, x=0–56 y=0–32; wide.** Cast/blocking: no named cast in frame, so eye-line is not
   applicable; the land alone — stone shelves, a dry wind moving the grass left, no building, no
...
**Purpose:** Run the whole Yugao/Karin argument as a walk, so the reader learns Naruto's method of
assessing people while the landscape tells them how far from Konoha this is.

1. **Top band, x=0–100 y=0–28; wide two-shot, low horizon.** Cast/blocking: Naruto and Zetsu walk
   left across the middle distance along a stone shelf; Zetsu walks fully emerged and upright beside
   him with no legs visible below the knee-line of the grass; Naruto's arms are folded. **B1** upper
...
### Spread 2 — pages 3–4: the eye that opens

**Source anchor:** ch19:29–43.

**Spread focal panel:** page 3, panel 5 — the slit red eye, awake, occupying a whole tier.

#### Page 3 — 6 panels

**Purpose:** Refuse Zetsu's question with a shrug, then run a fully silent approach so that the size
of the animal registers before anybody speaks to it.
...
2. **Top left, x=0–56 y=0–30; wide.** Cast/blocking: seen past the two small figures at the right
   ...
   overlap it; it reads as landscape until the reader finds the ear. No text.
3. **Middle band, x=0–100 y=34–62; extreme-wide, eye-level.** Cast/blocking: Naruto and Zetsu stand
   very small at the lip of the basin at frame right, facing left; Kurama fills the left two-thirds
   of the frame, asleep, half his adult mass, tails still. No text.
4. **Bottom right, x=66–100 y=66–100; extreme close-up.** Cast/blocking: a single closed eyelid,
   coarse orange fur around it; no other feature in frame. No text.
5. **Bottom centre, x=34–63 y=66–100; identical framing.** Cast/blocking: the same eye, open — huge,
   blood-red, the pupil a vertical slit. No text.
6. **Bottom left, x=0–31 y=66–100; extreme close-up on the pupil.** Cast/blocking: two tiny upright
   figures stand reflected in the black of the slit, one of them half in shadow. No text.
...
### Spread 3 — pages 5–6: the answer is a coffin

**Source anchor:** ch19:45–57.

**Spread focal panel:** page 5, panel 3 — the coffin standing up out of the rock in front of the
Kyūbi.
...
3. **Middle band focal panel, x=0–100 y=38–66; wide, low angle.** Cast/blocking: Naruto stands at
   ...
   straight seam and a single plain wooden coffin pushes up out of the ground and stands upright;
...
**Purpose:** Animate him, let the beast react before the man does, and demonstrate in three panels
that Minato has no standing here at all.
...
### Spread 4 — pages 7–8: the transfer

**Source anchor:** ch19:57–63.

**Spread focal panel:** page 8, panel 3 — the seal crossing from one body to the other.

#### Page 7 — 6 panels

**Purpose:** Let Minato recognise his son, get one sentence, and be switched off. The removal of his
personality must read as an administrative act, not as cruelty.
...
**Purpose:** Build the restoration as one continuous visible chain — stomach, arm, palm, fur, body —
so the reader can see where the chakra comes from and where it goes.

1. **Top right, x=58–100 y=0–36; medium.** Cast/blocking: Minato at frame right in profile facing
   left, his right palm laid flat against the fur of Kurama's foreleg; his left hand pressed to his
   own stomach. No text.
2. **Top left, x=0–54 y=0–36; close-up.** Cast/blocking: Minato's midsection alone; beneath the open
   coat a black seal blooms outward on his stomach in expanding rings. Origin of the transfer, stated
   in one panel. **SFX** thin, at the seal's edge: "FSSH". No balloon.
3. **Middle band focal panel, x=0–100 y=40–68; extreme-wide.** Cast/blocking: the seal's lines run
   out of Minato's stomach at frame right, down his extended right arm, across his palm at the point
   of contact, and spread over Kurama's foreleg, chest and flank to the left in a widening lattice
   that reaches the base of the tails. Origin, path and contact are all inside this one panel and
...
### Spread 5 — pages 9–10: his name

**Source anchor:** ch19:63–75.

**Spread focal panel:** page 9, panel 1 — Kurama at full size, near-splash.

#### Page 9 — 4 panels

**Purpose:** Pay the promise with scale, undercut it immediately with the paw strike, and give the
name in a wide quiet panel so that the reader understands it is the larger of the two gifts.

1. **Top band, x=0–100 y=0–58; near-splash, extreme-wide, low angle from the basin floor.**
   Cast/blocking: Kurama at his full glory, nine tails spread across the whole upper frame, the
   lattice gone, the ground below him fractured; Naruto is a speck standing at the lower right
   corner, facing left; Minato is a small figure at the foreleg at lower centre-left. No text.
2. **Middle right, x=55–100 y=62–80; medium.** Cast/blocking: Kurama's right forepaw swings down and
...
**Purpose:** Show what the name does to him and refuse him the chance to say so, then get Naruto off
the plateau alone.
...
**Page turn:** Nobody is going to watch this.

### Spread 6 — pages 11–12: two benches

**Source anchor:** ch19:77–97.

**Spread focal panel:** page 11, panel 6 — a man who will not shake hands building furniture so
another man has to sit where he can be looked at.

#### Page 11 — 6 panels

**Purpose:** Establish a second, smaller, quieter location; restore Minato's personality; and make
the Mokuton a piece of staging rather than a technique display.

1. **Top right, x=58–100 y=0–32; wide.** Cast/blocking: a different quarter of Dragon Land — a low
   rise of dry grass with a single dead tree on it, the plateau falling away behind; Minato stands
   blank in the middle distance facing right; Naruto walks in from the right edge. **CAP2** upper
   right, tail-less location card, small box: "ELSEWHERE IN DRAGON LAND". No balloon.
...
### Spread 7 — pages 13–14: the account, first half

**Source anchor:** ch19:99–125.

**Spread focal panel:** page 14, panel 1 — a single eyehole with a Sharingan in it, filling a
doorway.

#### Page 13 — 6 panels

**Purpose:** Run the safe half of the account — appointment, pregnancy, guard, birth — and cut back
to Naruto twice so the reader is watching a face, not reading a history.

1. **Top right, x=58–100 y=0–30; PLATE, medium.** Cast/blocking: the Hokage's office years ago in
...
**Purpose:** Give the masked man the page, keep every death implicit, and put Minato's one apology
where the reader can see Naruto not accept it.

1. **Top right, x=60–100 y=0–30; PLATE, medium, low angle.** Cast/blocking: the birth-room doorway
   seen from inside; a tall dark figure fills it in silhouette; the only readable feature is a single
   right eyehole in a dark mask with a red Sharingan burning inside it. Soft plate border. **B1**
...
### Spread 8 — pages 15–16: the account, second half

**Source anchor:** ch19:125–137.

**Spread focal panel:** page 16, panel 2 — two backs over an infant, and the claw stopped by them.

#### Page 15 — 7 panels

**Purpose:** Finish the fight, deliver the threat that explains the whole decision, and get the
reader to the clearing.

1. **Top right, x=62–100 y=0–30; PLATE, medium.** Cast/blocking: the living Minato and the masked man
   locked at close quarters on broken ground, a three-pronged kunai held horizontally between them;
   the mask's single eyehole is the brightest thing in the panel. Soft plate border. **B1** upper
   right, tail-less oval, Minato: "HE CAME FOR ME. I WAS FASTER."
2. **Top left, x=0–58 y=0–30; PLATE, close-up.** Cast/blocking: Minato's palm flat on orange fur; in
   the upper corner of the frame the Sharingan pattern is draining out of the Kyūbi's eye and the
   slit pupil is returning. Soft plate border. **B2** upper left, tail-less oval, Minato: "I CUT HIS
   CONTROL."
3. **Middle right, x=62–100 y=34–58; PLATE, wide.** Cast/blocking: a broken street; the masked man
   stands at frame left, half turned away, the eyehole still burning; the living Minato at frame
...
5. **Bottom right, x=66–100 y=62–100; PLATE, extreme-wide low angle.** Cast/blocking: a colossal toad
   ...
   the Kyūbi small beneath and left of it; village walls small and distant at the right edge. Soft
   plate border. **B6** upper right, tail-less oval, Minato: "THE TOAD CHIEF AND I PUT IT OUTSIDE THE
   VILLAGE."
6. **Bottom centre, x=34–63 y=62–100; PLATE, medium.** Cast/blocking: a clearing; golden chakra
   chains erupt out of Kushina's back at frame right, run left across the frame, and close around the
...
**Purpose:** Close the account on three plates and one wordless impact, then start the reckoning
inside the same page so the reader does not get a rest between them.

1. **Top right, x=62–100 y=0–30; PLATE, medium, low angle.** Cast/blocking: a vast horned darkness
   stands behind the living Minato, defined only by the outline and by one long pale arm that reaches
   forward through his chest; Minato's face is calm and lit from below. Do not render a full creature
   design. Soft plate border. **B1** upper right, tail-less oval, Minato: "THE DEAD DEMON CONSUMING
   SEAL TOOK ITS YIN HALF AND MY LIFE."
2. **Top left focal panel, x=0–58 y=0–30; PLATE, medium.** Cast/blocking: a single enormous claw
   driven down from the top of the frame and stopped; two adult backs are interposed beneath it over
   a small bundle on blankets; no wound and no blood are drawn. Soft plate border. No text.
...
### Spread 9 — pages 17–18: what the plan actually cost

**Source anchor:** ch19:139–165.

**Spread focal panel:** page 18, panel 4 — "AT THIS RATE, I SHOULD BE THE ROKUDAIME," said to a dead
Hokage across four feet of dry grass.

#### Page 17 — 7 panels

**Purpose:** List the four adults, take the apology without receipt, and let Naruto describe his own
hatred as a finished historical object.

1. **Top right, x=62–100 y=0–28; close-up.** Cast/blocking: Naruto facing left. **B1** upper right,
...
**Purpose:** Close the case with a shrug of a sentence, then give the two things Naruto has never said
aloud, and end the page with Minato's hand starting to move.
...
### Spread 10 — pages 19–20: released, and denied

**Source anchor:** ch19:167–207.

**Spread focal panel:** page 20, panel 8 — an eye the size of a house glaring at bare rock.

#### Page 19 — 7 panels

**Purpose:** Let the hand fall, give Minato the last word he is owed, release him without comment,
and walk Naruto back across the plateau in silence. Naruto must not be shown reacting.

1. **Top right, x=64–100 y=0–26; close-up.** Cast/blocking: Minato's half-raised right hand alone in
   frame against the pale sky, lowering back to his side; no face. No text.
2. **Top left, x=0–60 y=0–26; close-up.** Cast/blocking: Minato facing right, the hand now down.
   **B1** upper left, Minato: "YOU MAY NEVER CALL ME FATHER. YOU WILL ALWAYS BE MY SON." Tail points
...
**Purpose:** Return to the plateau, refuse Kurama twice, and end the volume's quietest chapter on a
beast with nothing to kill.

1. **Top right, x=64–100 y=0–24; two-shot.** Cast/blocking: Zetsu stands emerged to the ribs at frame
   left, facing right; Naruto walks in from the right edge facing left. **B1** upper right, Zetsu:
...
8. **Bottom left, x=0–47 y=76–100; wide, low angle.** Cast/blocking: bare rock where Naruto stood
   ...
   Zetsu went; Kurama's single enormous eye occupies the upper left of the frame, angled down at that
   empty ground; the pupil is a hairline slit. No text.

**Chapter turn:** Chapter 8 begins an hour later at ch19:209, in the Konoha council chamber, with
Koharu already on her feet.
...
- No caption box narrates an event. The two cards state place only, never elapsed time — the entire
  chapter is one continuous morning.
...
- **Minato's Edo Tensei body is consistent in every PRESENT panel:** cracked ash-grey skin, black
  sclera with a pale iris, Hokage coat over the flak vest, and the kunai with its tag visibly seated
  in the base of the skull from page 6 panel 2 onward. It is **never** in a PLATE panel — inside the
  flashback he is alive, uncracked, ordinary-eyed and carries no kunai. If a plate shows cracked skin
  the page fails.
- **Kurama's scale changes exactly once, on page 8.** He is half his adult mass on pages 3–8 and full
  size from page 9 panel 1 to the end. There is no intermediate panel and no later panel that shrinks
  him back.
- The restoration is one legible physical chain and must not be redistributed: seal blooms on
  **Minato's stomach** (p8 p2), runs down his arm to **his palm** (p8 p3), crosses at the **point of
  contact on the foreleg**, and spreads over Kurama's body (p8 p3), which then grows (p8 p4). If the
  seal appears on Kurama first, or in the air, or from Naruto, the page fails. **Naruto performs no
  part of the transfer** — the source is explicit that Minato does it, and Naruto stands apart
  watching in p8 panel 5.
- The Edo Tensei chain is likewise fixed: hand seals (p5 p1), spoken name (p5 p2), the ground splits
  and one coffin rises (p5 p3), the lid falls (p5 p4), the body is revealed (p5 p5), the kunai of
  orders is driven in (p6 p2), a single seal animates him (p6 p3–4). **Exactly one coffin.** No
  second body, no other resurrected figure anywhere in this chapter.
- The paw strike has one origin, one path, one contact: Kurama's right forepaw, down and left across
  page 9 panel 2, into Minato's chest, with the carryover drawn in panel 3. Minato is not shown
  injured afterwards — the Edo Tensei body does not mark.
- The Mokuton is the chapter's only other technique and it makes furniture. Origin is Naruto's palms
  on the ground (p11 p5), path is roots running out under the grass, contact is two finished benches
  (p11 p6). Nothing else in the chapter is grown, and no Mokuton erupts from his body.
- The two benches exist from page 11 panel 6 to page 19 panel 7 and are still standing, empty, in the
  chapter's second-to-last panel. Do not remove them and do not add a third seat.
- The bench axis is fixed from page 12 panel 1 to page 19: **Naruto right, Minato left, the dead tree
  between and above them.** It never reverses.
- **Zetsu is never drawn with legs** and never walks onto or off the plateau. He is emerged to the
  ribs on pages 1, 10 and 20, upright but grass-obscured below the knee on page 2, and sinking on
  page 20 panel 7.
- Content staging in the plates is by implication only, per the series bible: the murdered guards and
  nurses are an overturned lamp and one still open hand (p13 p6), the masked man is a silhouette and
  an eyehole (p14 p1), the explosive tags are on a blanket and detonate against empty ground (p14 p2
  and p3), the Shinigami is a horned darkness and one arm (p16 p1), and the claw that kills Kushina
  is stopped by two backs with no wound and no blood drawn (p16 p2).
- All in-panel writing is **ILLEGIBLE SCRIBBLE**: the tag on the kunai of orders (p6 p2) and the
  explosive tags (p14 p2). The only deliberate lettering is the chapter marker and the two location
  cards.
- Plate borders are soft grey-washed with no hard black gutter line; present-tense borders are the
  ordinary hard border. The transition out of the flashback is a single frayed border on page 16
  panel 3 and is not repeated.
- No balloon covers an eye, a mouth, the seal on page 8 panel 3, the point of contact on the foreleg,
  or Kurama's pupil on page 20 panel 8.
- Light, weather and time hold across the whole chapter: one continuous red-lit Dragon Land morning,
  no time card, no night, no rain. Konoha is never seen in the present tense.
