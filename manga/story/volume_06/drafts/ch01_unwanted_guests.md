# Volume 6, Chapter 1 — *Unwanted Guests*

**Source:** ch17:7–148. The chapter begins on the morning of the day Volume 5 ended anticipating,
...
| Needed | Existing | Gap |
|---|---|---|
| `naruto_v6_black` | `naruto_v4_black`, `naruto_v4_armor` | Age ~16, plain black attire, **no forehead protector**, **no gloves**, no armour, Sharingan **inactive** on this page. The existing sheets do not cover a bare-headed, unarmoured, dead-eyed state. |
| `medicine_bottle` | — | Page 13 panel 1 is an insert of the bottle. No sheet exists. Do not invent one; flag at the reference-gap audit. |
| `kakashi.png` | `kakashi.png` | Covered. |
| `zetsu.png` | `zetsu.png` | Covered. |
| `env_monument.png` | `env_monument.png` | Covered. The whole chapter is staged there. |

No other character or environment appears.

## Source effect

Four volumes of refused approaches are closed in one sitting. Kakashi finally asks the question he
has been carrying since Team 7, and Naruto answers it completely and honestly — Minato is nothing,
the villagers are nothing, Jiraiya is nothing, and Kakashi is the single exception. Kakashi's relief
is then cut off before he can build anything on it, and the exception is converted into a rule:
do not come here again without business. The reader should feel that Naruto gave Kakashi more than
he has ever given anyone, and took it back in the same breath.

Underneath that, the volume's actual subject is established without a word of explanation: the most
powerful person in Konoha tries to open his Sharingan on an empty morning, fails, and asks a plant
for a stronger drug.

## Continuity in

- The morning of the day Yugao's dinner takes place. Nothing has happened since ch16:683.
- Naruto is approximately sixteen, long blond hair, plain black attire, **no gloves, no forehead
  protector, no armour, no Gunbai, no sword.** The V3 ninjato is still lost and no replacement is
  carried in this volume.
- Naruto's **Sharingan is inactive and cannot be activated without medicine.** His eyes are plain
  blue for the entire chapter. The EMS does not appear.
- The Mangekyō is public knowledge; the village knows what he is. Nothing in this chapter re-reveals
  it.
- Zetsu's spore is on Danzō and Zetsu is running Naruto's errands. Naruto cannot sense him.
- Orochimaru is dead; the hideout and his scrolls are secured. The poison is already in Naruto's body
  and has not been diagnosed.
- Clones are already gathering the Edo Tensei materials off-page.
- Karin lives in Naruto's old house. Sasuke commands the restored Police Force. Neither appears here.

## Dramatic scene script

| Scene | Objective | Obstacle | Tactic | Turn | Decision | Consequence | Handoff |
|---|---|---|---|---|---|---|---|
| 1. The monument, alone (pp. 1–2) | Naruto wants an hour in which nothing touches him. | His own body will not obey; he cannot open his Sharingan. | Sit still, look at the village he intends to lead, wait it out. | The failure is not a mood — the hand shakes and the eye stays blue. | He decides the condition is temporary and refuses to treat it as more. | The reader knows he is ill before anyone in the story does. | Kakashi's chakra arrives from the right and the seclusion is over. |
| 2. Kakashi asks (pp. 3–6) | Kakashi wants to know what he did wrong in Team 7, and to apologise for the childhood he did not prevent. | Naruto refuses small talk and will not be softened into it. | Kakashi opens with the view, gets cut down, then states the question plainly and names his own reason: Naruto is his sensei's son. | Naruto tells him his reason is a dead man; Kakashi answers that the dead man started it but is not what kept him coming. | Naruto decides to answer once, because Kakashi tried. | Kakashi gets the only full answer Naruto has ever given anyone. | Naruto opens the answer with the first of three questions. |
| 3. The three questions (pp. 7–9) | Naruto wants to end the subject permanently by exhausting it. | Kakashi keeps hoping the answers will be softer than they are. | Naruto asks and answers for him — Minato, the villagers, Jiraiya — each one nothing. | The fourth answer inverts: there are many he could watch die without caring, and Kakashi is not one of them. | Kakashi decides to take that as friendship; Naruto decides not to let him. | The exception is granted and immediately fenced. | Kakashi stands up to leave on a warm note that has already been withdrawn. |
| 4. The rule (p. 10) | Kakashi wants to leave with something. | Naruto will not let a concession become a habit. | Naruto converts the exception into a standing instruction: business only. | "Stay away." | Kakashi accepts and goes without arguing. | Naruto is alone again and the account is closed on his terms. | The stone beside him opens. |
| 5. Zetsu and the hand (pp. 11–14) | Naruto wants a drug strong enough that his body stops being a variable. | Admitting the need injures his pride, and he has not yet diagnosed what is wrong. | He asks about the Edo Tensei first, states his contempt for the dependence, and only then holds out his hand. | Zetsu asks what happens if Orochimaru's scrolls hold nothing. | Naruto decides that is not an acceptable answer: look again. | The volume's engine is now visible — control lost, control seized. | Chapter 2 begins at ch17:149, the same day, with the date Volume 5 anticipated. |
...
**Standing visual locks for this chapter:** Naruto's irises are plain blue in every panel; no tomoe,
no Mangekyō, no red. He wears no forehead protector and no gloves. Kakashi's book is put away in
spread 2 panel 1 and never reappears. The two men do not look at each other until page 7 panel 1.

### Spread 1 — pages 1–2: the man who owns the view and not his own hand

**Source anchor:** ch17:9–27.

**Spread focal panel:** page 2, panel 2 — the plain blue eye that will not turn red.

#### Page 1 — 5 panels

**Purpose:** Place the chapter marker, establish the monument as chosen seclusion rather than
...
2. **Top left, x=0–58 y=0–31; wide downward view.** Cast/blocking: no named cast, so eye-line is not
   applicable; Konoha's market street runs left across the frame, awnings, stalls, and small figures
...
**Purpose:** Show the illness as a physical fact the reader can verify, without a caption, and bring
Kakashi in as an interruption rather than an arrival.

1. **Top right, x=62–100 y=0–30; close-up.** Cast/blocking: the same open right hand, fingers now
   spreading fully; no face in frame. **B1** upper right, tail-less thought balloon: "MY BODY ARGUES
   WITH ME."
2. **Top left focal panel, x=0–58 y=0–30; extreme close-up on the left eye.** Cast/blocking: Naruto's
   left eye fills the frame, lashes and brow visible, the iris a flat plain blue with no tomoe and no
   pattern; the pupil is ordinary. **B2** upper left, tail-less thought balloon: "UNWANTED GUESTS."
3. **Middle right, x=55–100 y=34–63; medium close.** Cast/blocking: Naruto's hand closes into a fist
   on his knee; his jaw is visible at upper right, facing left. **B3** upper right, tail-less thought
   balloon: "THEY WILL NOT STAY."
4. **Middle left, x=0–51 y=34–63; medium.** Cast/blocking: Naruto's head turns right; his eyes cut to
...
### Spread 2 — pages 3–4: get to the point

**Source anchor:** ch17:29–55.

**Spread focal panel:** page 3, panel 6 — "WHAT DO YOU WANT?" delivered without a turn of the head.
...
### Spread 3 — pages 5–6: it was never about liking you

**Source anchor:** ch17:53–63.

**Spread focal panel:** page 5, panel 4 — the two of them small above the village Kakashi is arguing
for.

#### Page 5 — 6 panels

**Purpose:** Close the opening Kakashi thought he heard, then make Kakashi name his own motive out
loud so Naruto can take it apart.

1. **Top right, x=68–100 y=0–27; close-up.** Cast/blocking: Kakashi faces left, the visible eye
   sharpening. **B1** upper right, Kakashi: "DID NOT?" Tail points to visible Kakashi's mouth.
...
**Purpose:** Give Kakashi the apology in full, unanswered, and end the page on the single word that
tells the reader Naruto has decided to reply.

1. **Top right, x=62–100 y=0–29; close-up.** Cast/blocking: Kakashi faces left, eye steady. **B1**
   upper right, Kakashi: "THAT WAS THE REASON I STARTED." Tail points to visible Kakashi's mouth.
   **B2** lower right, Kakashi: "IT IS NOT THE REASON I KEPT COMING." Tail points to the same visible
   mouth.
...
### Spread 4 — pages 7–8: nothing, nuisances, nothing
...
**Purpose:** Turn the answer into a structured interrogation Naruto conducts on himself, and make
the Minato dismissal a picture rather than a line.

1. **Top band, x=0–100 y=0–27; wide two-shot.** Cast/blocking: Naruto at left has turned fully to
   face right; Kakashi at right faces left; their eye-lines meet across the whole panel for the first
   time. **B1** upper right, Naruto: "I WILL SAY THIS ONCE AND NEVER AGAIN." Tail points to visible
   Naruto's mouth. **B2** lower left, Naruto: "I DISLIKE PETTY THINGS FROM THE PAST. BUT YOU TRIED,
   SO I WILL ANSWER." Tail points to the same visible mouth.
2. **Middle right, x=68–100 y=31–62; close-up.** Cast/blocking: Naruto faces right, eyes level.
   **B3** upper right, Naruto: "WHAT DO YOU THINK I FEEL WHEN I SEE MINATO'S FACE?" Tail points to
   visible Naruto's mouth.
3. **Middle centre, x=34–65 y=31–62; close-up.** Cast/blocking: Kakashi faces left, hesitating; the
   eye narrows. **B4** upper centre, Kakashi: "...THE MAN WHO MADE YOUR LIFE MISERABLE?" Tail points
   to visible Kakashi's mouth.
4. **Middle left, x=0–31 y=31–62; close-up.** Cast/blocking: Naruto faces right, no change of
   expression. **B5** upper left, Naruto: "NOTHING. I LOOK AWAY." Tail points to visible Naruto's
   mouth.
...
### Spread 5 — pages 9–10: the exception and the rule

**Source anchor:** ch17:89–105.

**Spread focal panel:** page 9, panel 3 — the only sentence in four volumes in which Naruto exempts
somebody.

#### Page 9 — 5 panels

**Purpose:** Give the exception a full dominant panel, then take it back inside the same page so the
reader never gets to settle into it.
...
**Purpose:** Let Kakashi try to leave on a warm note and be handed a standing rule instead; close the
account on Naruto's terms.

1. **Top right, x=62–100 y=0–30; medium.** Cast/blocking: Kakashi stands at frame centre and brushes
   grit from his trousers, facing left toward the seated Naruto. **B1** upper right, Kakashi: "YOU
   SHOULD LIGHTEN UP SOMETIMES, NARUTO." Tail points to visible Kakashi's mouth.
2. **Top left, x=0–58 y=0–30; medium.** Cast/blocking: Kakashi turns right, presenting his back, one
   hand lifting in a half wave; Naruto remains seated at the far left edge. **B2** upper left,
   Kakashi: "THANKS FOR THE TIME. I WILL SEE YOU AROUND." Tail points to visible Kakashi's mouth.
3. **Middle right, x=51–100 y=34–62; close-up.** Cast/blocking: Naruto seated, facing left over the
...
### Spread 6 — pages 11–12: the thing he cannot sense, and the eye that will not open

**Source anchor:** ch17:107–131.

**Spread focal panel:** page 12, panel 4 — the straining blue eye.
...
**Purpose:** Answer "how are you holding up" with three silent identical panels that the reader can
read faster than Naruto will admit anything.
...
4. **Middle centre focal panel, x=34–65 y=33–63; identical framing, one step tighter.**
   Cast/blocking: the same eye strains — the lid pulled wider, a vein tightening at the temple, the
...
### Spread 7 — pages 13–14: the price of the dependence and the open hand

**Source anchor:** ch17:131–147.

**Spread focal panel:** page 14, panel 5 — the empty open palm held out over Konoha.

#### Page 13 — 6 panels

**Purpose:** State the injury to his pride in his own voice, then move him straight past it to
logistics, so the reader sees the wound and the refusal to sit in it.

1. **Top right, x=62–100 y=0–30; insert close-up, cut-away.** Cast/blocking: no cast, so eye-line is
...
**Purpose:** End the chapter on the request, not on the plan — the strongest man in Konoha holding
...
5. **Bottom left focal panel, x=0–47 y=64–100; extreme close-up.** Cast/blocking: the open empty palm
   ...
   blur; no face is in frame. No text.

**Chapter turn:** Chapter 2 begins at ch17:149, the same evening, in the Uchiha compound kitchen.
...
- Nobody names Danzō, Root, the Akatsuki leader, Kurama, Minato's house, Yugao, Karin, Mei, or the
  Hiraishin. The only forward information in the chapter is the Edo Tensei preparation, which the
  source places here.
- Naruto never says what is wrong with him, because in the source he does not know: page 13 has him
  refuse the dependence without naming the cause, and the blood analysis and full body scan are not
  mentioned to Kakashi at all.
- No caption box, narration box, or time card is used in this chapter.

## Visual and continuity QA

- Naruto's irises are plain blue in all 81 panels. No tomoe, no Mangekyō, no Eternal Mangekyō, no
...
- The chapter axis is fixed after page 3 panel 1: Naruto left, Kakashi right, the village below and
  ...
  Naruto once before that, on page 5 panel 5.
- Zetsu emerges from solid stone and never walks on. He is a half-figure on page 11 panel 2, waist-up
  on panel 5, and half-sunk on page 14 panel 1. He is never shown with legs.
- The medicine bottle on page 13 panel 1 is an insert of a room elsewhere; **nobody drinks it in this
  chapter.** The two on-page doses belong to Chapter 4 and Chapter 5 per the volume hard lock.
- No jutsu is used by anyone. No Shunshin is drawn for Kakashi's exit — only a small dispersing leaf
  swirl on page 10 panel 6, which does not read as a technique with a named origin.
- All in-panel writing is ILLEGIBLE SCRIBBLE: shop signage on page 1 panel 2 and page 8 panel 3, and
  the bottle label on page 13 panel 1. The only deliberate lettering is the chapter marker.
- No balloon covers a face, an eye, or the open palm on page 14 panel 5.
- Weather, light and time hold across the whole chapter: one continuous morning, no time card, no
  scene change. The chapter never leaves the Hokage Monument.
