# Volume 6, Chapter 6 — *Ten Cloaks*

**Source:** ch18:389–589. The chapter begins at the "Uchiha compound" card (ch18:389), immediately
after Chapter 5's last panel, and ends at ch18:571 with Naruto reverse-summoning himself out of his
...
| Needed | Existing | Gap |
|---|---|---|
| `naruto_v4_armor.png` | present | Covers the whole chapter — full armour, forehead protector on, **ordinary three-tomoe Sharingan**, Gunbai not carried. Two audit notes, not new sheets: he is ~16 rather than 13, and the heavy right bang is pushed aside once (p16 panel 1) to show the right eye. |
| `env_akatsuki_meeting` | — | No sheet. Pages 7–10. The ten figures are **holographic images**, not physically present: semi-transparent, internally lit, casting no shadow, standing in a ring in an undefined dark space. That property is the scene and cannot be inferred. |
| `nagato_pain_tendo` | — | No sheet. The Leader. Rinnegan; nine balloons; framed alone in close-up on p10 panel 4. |
| `konan` | — | No sheet. Present at the ring and stays behind with the Leader. No dialogue. |
| `tobi_masked` | — | No sheet. Obito as Tobi: mask with a **single right eyehole showing a Sharingan**. Five balloons and two close-ups. Must **not** be the unmasked Obito, who does not appear until Chapter 15. |
| `hidan` | — | No sheet. Three balloons. |
| `kakuzu` | — | No sheet. One balloon. |
| `sasori` | — | No sheet. One balloon. |
| `deidara` | — | No sheet. One balloon. |
| `kabuto_akatsuki` | `kabuto.png` | Akatsuki cloak, conscious, upright, watching. The existing sheet is Orochimaru-era; his last appearance in this volume was unconscious inside a memory inset in Chapter 3. He has no dialogue here. |
| `env_uchiha_training_ground` | — | No sheet. Pages 3–6. The compound's own ground where the clones work; **not** `env_training_ground_7`. |
| `env_uchiha_house_kitchen` | — | No sheet. Pages 1–2, the interior room where Sasuke is working. |
| `env_naruto_bedroom` | — | No sheet. Pages 11–16 — his own room, its sealed inner room, its door and the passage outside it. `env_uchiha_compound.png` is an exterior sheet and does not cover the interior; decide at the reference-gap audit whether one interior sheet serves both this and `env_uchiha_house_kitchen`. |
| `edo_tensei_coffin` | — | **New to this chapter; not on the previous agent's gap list.** A plain unmarked upright wooden coffin with a paper seal across the seam, seen closed on p11 panel 2 and shut away on p12 panel 6. It may not need its own sheet — flag it at the audit rather than assuming either way. |
| `itachi.png`, `kisame.png`, `sasuke_16.png`, `karin.png`, `zetsu.png`, `yugao.png`, `env_uchiha_compound.png` | present | Covered. Yugao is in ANBU uniform with the mask off and hooked at her hip, which `yugao.png` covers; `yugao_v4.png` and the `yugao_civilian` gap are not needed here. |

**Zetsu is not an Akatsuki member in this adaptation** and must not appear at the assembly. The ring
is exactly ten: the Leader, Konan, Itachi, Kisame, Sasori, Deidara, Hidan, Kakuzu, Tobi and Kabuto.
Guren, Danzō, Tsunade, Orochimaru and Minato are named and none of them appears. **The Crystal
Palace is described in dialogue and never drawn** — its establishing image belongs to Chapter 15.

## Source effect

Three rooms, and in each of them somebody says his name out loud to somebody who did not have it
before.

Sasuke says it as a colleague: the cover held, he did not have to lie once, and in four days a
massacre has become the founding case of a legal institution. Karin says it as a person he has
damaged into ambition — she was taken, she could not stop it, and the thing she wants now is to be
made into a weapon, which he agrees to without a flicker and then argues her out of the philosophy
underneath it. And a masked man in a circle of holograms says it as a warning, twice: once to eight
of the most dangerous people alive, and once, privately, to the only one of them who could actually
do something about it.

The chapter's last beat is the one that has to land hardest and quietest. Yugao thanks him for a
rescue he did not perform. Zetsu wore his face into that cell; she will never learn otherwise in
this volume. She holds him, she thanks him, she pushes his bang aside and kisses his cheek, and he
gives her **nothing** — and then she says four words that rearrange his evening and walks off before
he can ask what they mean. The reader should feel the two halves of him in the same doorway: the man
Akatsuki has just flagged as a threat, standing perfectly still because a woman put her arms around
him.

## Continuity in

- Continuous with Chapter 5. It is late morning of the same day; the council sits at one o'clock and
  Sasuke is due there with the files.
- Naruto is in **full armour with his forehead protector on**, restored in Chapter 5. The Gunbai
  stays at home and is not carried.
- His eyes are the **ordinary three-tomoe Sharingan**, from the second and last on-page dose of the
  volume in Chapter 5 page 2. No further dose is shown or implied in Volume 6.
- Sasuke was briefed and given the evidence the previous night; he covered for Naruto knowingly and
  willingly, and this chapter is where that is confirmed on page.
- Karin was taken by Root and rescued by **Zetsu wearing Naruto's form.** She thanks Naruto directly.
  She has never seen Zetsu.
- Yugao was taken and rescued the same way and believes Naruto did it. **She must not learn
  otherwise in this volume.**
- Between Chapter 5 and this chapter, off-page, Naruto has used the Shinigami mask and taken Minato's
  soul out of the death god's stomach. He did not let the man speak and has stored him in a coffin.
  **The retrieval is never dramatised** — the coffin is all the reader gets.
- Guren has nearly finished the Crystal Palace. Konoha does not know Naruto controls Oto.
- Danzō is alive, crippled and condemned; his execution is never depicted anywhere in this volume.
- Orochimaru's poison is undiagnosed. Nobody but Naruto and Zetsu knows anything about it.

## Dramatic scene script

| Scene | Objective | Obstacle | Tactic | Turn | Decision | Consequence | Handoff |
|---|---|---|---|---|---|---|---|
| 1. The house (pp. 1–2) | Naruto wants confirmation that the cover held. | Sasuke has just carried an S-rank lie into the Hokage's office and is entitled to be nervous about it. | Answer him in single words and let him talk himself calm. | Sasuke works out that he was never lying — the operation really was the Police Force's. | Naruto tells him Tsunade will never suspect him, and means it as an assessment rather than comfort. | The Police Force is proven, and the man who owns it did not have to perjure himself. | Karin is waiting. |
| 2. The training ground (pp. 3–6) | Karin wants to never be helpless again. | She believes the world is a food chain and she is on the wrong end of it. | She asks to be trained as hard as he can train her. | He agrees instantly — and then attacks the belief instead of the weakness. | He tells her to make her own principles rather than conform to the world's, and gives her a place, a job and a name to work for. | Karin gets Oto, Guren and a future; the reader gets the Crystal Palace without seeing it. | She asks whether Yugao is his girlfriend. He leaves mid-question. |
| 3. Ten cloaks (pp. 7–10) | The Leader wants his organisation reassembled and pointed. | Two new members nobody voted for, one of whom is not even S-rank. | Introduce them, refuse to explain them, and assign the Bijuu. | Tobi's contribution is not about a jinchūriki at all. It is a warning about a sixteen-year-old in Konoha. | After the others leave, Tobi tells the Leader to take the Kyuubi personally. | Naruto's name is now inside Akatsuki as a threat, and Nagato has been pointed at him. | The Leader says nothing at all. |
| 4. His room (pp. 11–12) | Naruto wants to leave for Dragon Land without being seen going. | Someone is coming up the passage. | Send Zetsu into the floor and shut the inner door on the coffin. | It is Yugao, whom he cannot dismiss and does not want to. | He opens the door instead of vanishing. | The only person who can make him wait is standing in it. | The door opens. |
| 5. The doorway (pp. 13–16) | Yugao wants to thank him for saving her life. | He did not save her life, and cannot say so. | She notices the armour, gets one word, and puts her arms around him anyway. | She calls Danzō's punishment "a little extreme" and thanks him for it in the same breath. | He does not correct her, does not return the embrace, and does not react to the kiss. | She leaves him with an appointment he did not agree to and no explanation of it. | Chapter 7 opens in Dragon Land at ch19:5. |
...
**Standing visual locks for this chapter.** Naruto is in **full armour with the forehead protector
on** in every panel, with the **ordinary three-tomoe Sharingan** in both eyes; no Eternal Mangekyō
anywhere, and no Gunbai. The ten Akatsuki figures on pages 7–10 are **holographic images** —
semi-transparent, lit from inside, casting no shadow, with the floor visible through their feet — and
nothing may suggest they share a physical room. **Tobi's mask has one eyehole, on the right, with a
three-tomoe Sharingan behind it**; the mask has no mouth opening, so his balloon tails point to the
lower edge of the mask, the same convention this volume used for Root in Chapter 4. Every written
surface — the coffin's seal, Sasuke's files, the seal ring on the floor — is ILLEGIBLE SCRIBBLE,
never readable words. The only deliberate lettering is the chapter marker and the four cards.

### Spread 1 — pages 1–2: the cover held

**Source anchor:** ch18:389–415.

**Spread focal panel:** page 2, panel 3 — two clan heads at a kitchen table with a legalised massacre
between them.

#### Page 1 — 6 panels

**Purpose:** Open in the most ordinary room in the volume, and let the ordinariness carry the weight —
the two of them are debriefing a hundred and fifty deaths over a stack of paperwork.

1. **Top band, x=0–100 y=0–30; wide establishing exterior.** Cast/blocking: the Uchiha compound in
   late-morning light — the main house behind its wall at frame centre, the swept district empty
   around it. Protect x=6–40 y=4–19 as plain sky: no roofline, branch, bird or balloon may enter this
...
**Purpose:** Give Sasuke one honest worry, answer it in a way that is not reassurance, and get out
before the scene becomes warm.

1. **Top right, x=62–100 y=0–26; medium.** Cast/blocking: Sasuke leans back off the table, facing
...
6. **Bottom left, x=0–31 y=62–100; medium.** Cast/blocking: black flame breaks out from **Naruto's own
   ...
   this panel. **SFX** rising through the spiral: "VWOOM". No balloon.

**Page turn:** She asked for him.

### Spread 2 — pages 3–4: the girl who wants to be a weapon

**Source anchor:** ch18:417–441.

**Spread focal panel:** page 4, panel 3 — two people arguing about the world in front of two hundred
...
**Purpose:** Agree in three words, then spend the rest of the page taking apart the belief she just
built out of the worst night of her life.

1. **Top right, x=62–100 y=0–26; close-up.** Cast/blocking: Naruto facing left. **B1** upper right,
   Naruto: "INTERESTING." Tail points to visible Naruto's mouth.
2. **Top left, x=0–58 y=0–26; close-up.** Cast/blocking: the same face, tighter. **B2** upper left,
   Naruto: "I WILL MAKE YOU STRONG." Tail points to visible Naruto's mouth.
3. **Middle band focal panel, x=0–100 y=30–58; wide.** Cast/blocking: the two of them small at the
   frame's near edge — Karin at frame left facing right, Naruto at frame right facing left — with the
   entire field of working clones filling the space behind and above them. **B3** upper right, Karin:
   "AS LONG AS WE LIVE IN THIS WORLD WE HAVE TO GET STRONG. THE STRONG ALWAYS DEVOUR THE WEAK." Tail
   points to visible Karin's mouth. **B4** lower left, Naruto: "IS THAT SO." Tail points to visible
   Naruto's mouth.
4. **Bottom right, x=68–100 y=62–100; medium.** Cast/blocking: Karin facing left, arms wrapped around
   her own elbows. **B5** upper right, Karin: "I WAS WEAK. THAT IS WHY I WAS TAKEN. IT IS JUST HOW
...
### Spread 3 — pages 5–6: a place to be sent

**Source anchor:** ch18:441–489.

**Spread focal panel:** page 5, panel 6 — the palace described and not shown.

#### Page 5 — 6 panels

**Purpose:** Give Karin a future in four lines, and deliberately withhold the image that goes with it.
...
**Purpose:** Close Karin's thread on a job, a condemned man and a question he will not stay to hear
the end of.

1. **Top right, x=68–100 y=0–26; close-up.** Cast/blocking: Karin, and the whole argument has left her
   face; she has gone dreamy. **B1** upper right, Karin: "IT MUST BE BEAUTIFUL." Tail points to visible
   Karin's mouth.
2. **Top centre, x=34–65 y=0–26; medium.** Cast/blocking: Naruto facing left. **B2** upper centre,
   Naruto: "YOU WILL LIVE THERE AND HELP GUREN, ONCE I HAVE TAUGHT YOU THE BASICS." Tail points to
   visible Naruto's mouth.
3. **Top left, x=0–31 y=0–26; close-up.** Cast/blocking: the dream goes straight back out of Karin's
   face. **B3** upper left, Karin: "KONOHA ALREADY KNOWS I AM WITH YOU. THEY WILL WORK OUT OTO." Tail
   points to visible Karin's mouth.
4. **Middle band, x=0–100 y=30–56; wide.** Cast/blocking: the two of them, Naruto at frame right,
   Karin at frame left. **B4** upper right, Naruto: "YOU WILL KEEP YOURSELF HIDDEN UNTIL THE
   REBUILDING IS DONE. YOU DID IT FOR OROCHIMARU FOR YEARS." Tail points to visible Naruto's mouth.
   **B5** upper left, Karin: "AND AFTER THAT?" Tail points to visible Karin's mouth. **B6** lower
   right, Naruto: "AFTER THAT, WHATEVER KONOHA SAYS, I WILL HANDLE." Tail points to visible Naruto's
   mouth.
5. **Bottom right, x=68–100 y=60–100; medium.** Cast/blocking: Naruto already half-turned away toward
   frame left. **B7** upper right, Naruto: "GO BACK TO YOUR HOUSE. I HAVE THINGS TO DO BEFORE I TRAIN
   YOU." Tail points to visible Naruto's mouth. **B8** lower right, Karin: "IS HE GOING TO BE A
   PROBLEM? SASUKE SAID HE IS STILL ALIVE." Tail points to visible Karin's mouth.
6. **Bottom centre, x=34–65 y=60–100; close-up.** Cast/blocking: Naruto facing left. **B9** upper
   centre, Naruto: "NO. HE WILL BE EXECUTED SOON." Tail points to visible Naruto's mouth. **B10**
   lower centre, Karin: "BEFORE I FORGET — YUGAO-SAN SAID SHE WANTS TO SPEAK WITH YOU." `OFF`, tail
   exits the left edge toward Karin.
7. **Bottom left, x=0–31 y=60–100; medium.** Cast/blocking: Karin at frame right facing left, mouth
   still open on the question; where Naruto was standing there is a scorched disc of grass with the
   last of a black-flame spiral unwinding upward out of frame. **B11** upper left, Karin: "IS
   YUGAO-SAN YOUR GIRLFRIEND?" Tail points to visible Karin's mouth. **B12** lower left, Karin, small
   balloon: "...OF COURSE." Tail points to the same visible mouth. **SFX** thin, at the disc: "VWOOM".

**Page turn:** Somewhere else, ten people are standing in a circle.

### Spread 4 — pages 7–8: ten cloaks

**Source anchor:** ch18:491–525.

**Spread focal panel:** page 7, panel 1 — the ring.

#### Page 7 — 5 panels

**Purpose:** Establish that these ten are not in a room together, sort the reader into who is who
through three voices, and hold the two new faces back until the bottom of the page.

1. **Top band focal panel, x=0–100 y=0–36; extreme-wide, low angle.** Cast/blocking: an undefined dark
   space with no walls, no ceiling and no readable floor. Ten tall figures in black cloaks patterned
   with red clouds stand in a wide ring facing inward. **Every one of them is a holographic image** —
...
### Spread 5 — pages 9–10: an assignment list, and a name that is not on it

**Source anchor:** ch18:519–539.

**Spread focal panel:** page 9, panel 6 — the warning.

#### Page 9 — 6 panels

**Purpose:** Get the assignments out in three panels because the volume plan says to compress them,
then give the page's whole bottom third to the two sentences the scene exists for.

1. **Top right, x=62–100 y=0–26; medium.** Cast/blocking: the Leader at frame right with Konan behind
...
5. **Bottom left, x=0–51 y=66–100; wide.** Cast/blocking: the same space, entirely empty. No ring, no
   figures, no light. No text.

**Page turn:** Back to the man they were talking about.

### Spread 6 — pages 11–12: a box in a shut room

**Source anchor:** ch18:539–555.

**Spread focal panel:** page 11, panel 2 — the coffin.

#### Page 11 — 6 panels

**Purpose:** Deliver the largest off-page event in the volume — the Shinigami mask, and a soul taken
out of a death god's stomach — as one closed box and two thoughts, exactly as the source does.

1. **Top band, x=0–100 y=0–28; wide establishing exterior.** Cast/blocking: the Uchiha compound again,
   the sun higher than page 1; ordinary, swept, quiet. **CAP1** upper right, tail-less location/time
   card, small box: "UCHIHA COMPOUND — LATER THAT MORNING". No balloon.
2. **Middle right focal panel, x=68–100 y=32–58; medium interior.** Cast/blocking: a dark sealed inner
   room with no window. A **plain unmarked upright wooden coffin** stands against the far wall, lid
   closed, with a single paper seal pasted across the seam; every mark on the seal is ILLEGIBLE
   SCRIBBLE, not readable words. There are no figures in the frame and nothing else in the room.
   **Nothing of the retrieval is shown and the Shinigami mask is not drawn anywhere in this chapter.**
   No text.
3. **Middle centre, x=34–65 y=32–58; close-up.** Cast/blocking: Naruto in his own room, armoured,
   facing left at nothing in particular; his hands are clean and dry. **B1** upper centre, tail-less
...
**Purpose:** Interrupt him mid-sentence, get Zetsu into the floor, and close the coffin's room before
anyone can see it.

1. **Top right, x=62–100 y=0–26; close-up.** Cast/blocking: Naruto facing left. **B1** upper right,
   Naruto: "GOOD. I—" Tail points to visible Naruto's mouth.
2. **Top left, x=0–58 y=0–26; close-up.** Cast/blocking: Zetsu's face; his head has come round toward
...
6. **Bottom band, x=0–100 y=60–100; wide.** Cast/blocking: the room. The floorboards where Zetsu was
   ...
   left toward the passage door. **Zetsu is gone before the outer door is touched.** No text.

**Page turn:** Who is in the passage.

### Spread 7 — pages 13–14: she is thanking the wrong man

**Source anchor:** ch18:555–563.

**Spread focal panel:** page 13, panel 3 — Yugao in the passage.
...
3. **Middle band focal panel, x=0–100 y=30–64; wide.** Cast/blocking: Yugao standing in the passage
   outside — ANBU uniform, **mask off and hooked at her hip**, long purple hair loose down her back —
   with one hand still half raised from having been about to knock. She is looking straight at him and
...
6. **Bottom band focal panel, x=0–100 y=60–100; wide.** Cast/blocking: Yugao puts both arms around him
   over the armour and lays her cheek beside his ear; **his arms stay at his sides** and nothing in
   his posture, shoulders or eyes changes by a degree. No text.

**Page turn:** What she came to say.

### Spread 8 — pages 15–16: thank you

**Source anchor:** ch18:563–571.

**Spread focal panel:** page 16, panel 4 — four words, and no explanation.
...
4. **Bottom right, x=55–100 y=66–100; tight close-up.** Cast/blocking: Naruto's eyes, ordinary
   ...
   balloon and no thought.** No text.
5. **Bottom left, x=0–51 y=66–100; medium.** Cast/blocking: she steps back a half pace, one hand
   already rising toward the heavy right bang across his face. No text.

#### Page 16 — 7 panels

**Purpose:** Give her the last move, give him no reaction to it, and end the chapter on his own
technique taking him out of a conversation he did not finish.

1. **Top right, x=68–100 y=0–24; insert close-up.** Cast/blocking: no full faces; her fingers push the
   heavy right bang aside, and behind it the right eye is visible — ordinary three-tomoe Sharingan. No
   text.
2. **Top centre, x=34–65 y=0–24; close-up.** Cast/blocking: she kisses his right cheek, both in
   profile. **No SFX and no balloon** — the silence is the beat and nothing may be added here.
...
6. **Bottom centre, x=34–65 y=60–100; medium.** Cast/blocking: Yugao walking away down the passage
   ...
   corner of her mouth that is visible in three-quarter is smiling. No text.
7. **Bottom left, x=0–31 y=60–100; medium.** Cast/blocking: the door shut and Naruto alone in the room.
   He runs a short set of hand seals and brings his **right palm down flat onto the floorboards**; a
   ring of seal script spreads outward from under that palm across the boards as ILLEGIBLE SCRIBBLE,
   and he goes in a burst of white smoke. Origin (his own palm on the floor), path (the spreading
   ring) and result (his disappearance) are all inside this panel. **SFX** at the palm: "POF". No
   balloon.

**Chapter turn:** Chapter 7 begins at ch19:5, in Dragon Land, with Zetsu already there and Kurama
asleep.
...
- No caption box narrates an event. The four cards state place and elapsed time only.

## Visual and continuity QA

- **Eyes.** Ordinary three-tomoe Sharingan in both of Naruto's eyes on every panel of this chapter,
  including the right eye revealed under the bang on p16 panel 1. No Eternal Mangekyō anywhere. Tobi
  carries one three-tomoe Sharingan behind the right eyehole; the Leader carries the **Rinnegan**;
  Itachi's eyes are ordinary and **not** Mangekyō in any panel. **Sasuke's Sharingan is not active and
  he has no Mangekyō.**
- **Dress.** Full armour and forehead protector in every panel; the Gunbai is not carried and is not
  drawn. The armour is what Yugao remarks on and it must be unmistakable from p1 panel 2 onward.
- **No medicine appears in this chapter and nobody drinks anything.** Both of the volume's on-page
  doses have been spent — Chapter 4 page 11 and Chapter 5 page 2 — and the hard lock is now closed.
- **The holograms are the whole point of the Akatsuki scene.** All ten figures on pp. 7–10 must be
  semi-transparent, internally lit, shadowless, with ground visible through their feet, and lit
  inconsistently with each other. If they read as ten people standing in one cave, the sequence fails.
  Nothing they wear or hold casts a shadow and nothing in the space is touched.
- **The ring is exactly ten and Zetsu is not in it.** The Leader, Konan, Itachi, Kisame, Sasori,
  Deidara, Hidan, Kakuzu, Tobi, Kabuto. Zetsu appears in this chapter only on pp. 11–12, alone with
  Naruto, in his true halved form.
- **Tobi must be the masked Tobi**, never the unmasked Obito, and the mask has exactly one eyehole,
  on the right. His mouth is never drawn and never visible; every one of his balloon tails points to
  the lower edge of the mask.
- **The Leader's ring position is fixed at frame right** from p8 panel 1 onward, so every off-panel
  balloon of his exits the **right** edge. Tobi's off-panel balloon on p10 panel 4 exits the **left**
  edge, because he stands opposite.
- **The Crystal Palace is never drawn** — no establishing shot, no inset, no imagined image, no
  reflection. Oto is never drawn either. Both belong to later chapters and this chapter's Karin scene
  must carry them in dialogue alone.
- **The Shinigami mask is never drawn** and the retrieval of Minato's soul is never staged. The coffin
  on p11 panel 2 is closed, plain, unmarked and sealed, and it is shut behind an inner door on p12
  panel 6 before Yugao is at the door. **Minato does not appear in this volume until Chapter 7.**
- **Black-flame Shunshin appears four times** — p1 panel 2 (arrival), p2 panel 6 (departure), p3 panel
  2 (arrival), p6 panel 7 (its aftermath). Every time the flame originates at **his own feet and the
  ground or floor beneath them**, rises around him, and leaves a scorched disc. If it appears from a
  hand, from the eyes, or from empty air, the page fails. **Amaterasu is not used, nothing is set on
  fire, no Mokuton is used, and no Susano'o appears in this chapter.**
- **The reverse summoning on p16 panel 7 is the only other technique in the chapter.** Hand seals,
  then the right palm flat on the floor, then a ring of seal script spreading out from under that
  palm, then white smoke — not black flame. That distinction is source-explicit and separates his
  local travel from his long-distance travel.
- **The clone field on pp. 3–6 is background and stays background.** Fifty seated over scrolls, the
  rest working plain uncoloured chakra spheres at various stages of collapse. **No elemental Rasengan
  and no Katon: Rasengan exists in this volume** — the spheres must be plain and several must be
  visibly failing.
- **Yugao must not see Zetsu, the coffin, or the inner room.** Zetsu is into the floor by p12 panel 4
  and the inner door is shut in p12 panel 6, one panel before Naruto's hand touches the outer door.
  A reviewer must confirm the coffin is not visible in any panel from p13 onward.
- **Naruto gives no physical reaction to the embrace or the kiss.** p14 panel 6, p15 panels 1–4 and
  p16 panels 2–3 must all show his arms at his sides, his shoulders unchanged, and his eyes unmoved.
  He does not return the embrace at any point. This is the source's beat and softening it fails the
  page.
- **All in-panel writing is ILLEGIBLE SCRIBBLE:** Sasuke's files (pp. 1–2), the coffin's seal (p11
  panel 2), and the seal ring on the floorboards (p16 panel 7). The only deliberate lettering is the
  chapter marker and the four cards.
- **Pages 7, 10, 13 and 15 are deliberately five-panel pages** so that the ring, the empty space, the
  doorway and the embrace can each run at large scale. Every other page is six or seven panels.
- Naruto leaves for Dragon Land armoured, with the coffin sealed at home, Karin placed, the Police
  Force proven, Akatsuki aware of him, and an appointment tonight that he did not agree to and does
  not understand. Chapter 7 inherits all of it.
