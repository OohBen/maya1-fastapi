...
DIALOGUE = {
 ...
 "p10": ["Hold still. You've got broth all over your face.",
         "Ha! Let the boy eat like a boy, Ayame.",
         "You come back whenever you're hungry, kid. Any night. You hear me?"],
 ...
 "p14": ["...Huh.",
         "That can't be true.",
         "Madara died fighting the Shodaime. It's in the book you gave me, old man."],
 "p15": ["Hm. Perhaps you are right.",
         "Since you won't believe that - how about I tell you about your parents instead."],
 "p16": ["...You knew them?",
         "Tell me. Tell me everything, right now!",
         "Sit down, Naruto."],
 "p17": ["And listen carefully. I will say this only once.",
         "...Okay.",
