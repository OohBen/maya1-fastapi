...
PAGES = [
 ...
 ("p14", dict(scene="dialogue", light="day", cast="crowd", mood="tense", panels=6),
  ...
  "PANEL 4 (small lower-right): the blond teen's shoulder and jaw are CROPPED INTO frame at the near edge so the white-haired man is visibly addressing him, not muttering alone. the white-haired man exhales through his nose and gives up the "
  "order for now.\n"
  "PANEL 5 (medium lower-centre, a TWO-SHOT): the blond teen MUST BE VISIBLE IN THIS PANEL, standing silent and unmoved at frame right with his face readable, so it is plain who the white-haired man is speaking to. his expression hardens into something more serious. He steps "
