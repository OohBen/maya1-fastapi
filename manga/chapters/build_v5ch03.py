...
PAGES = [
 ...
 ("p13", dict(scene="dialogue", light="day", cast="crowd", mood="tense", panels=6),
  ...
  "not a challenge.\n"
  "PANEL 3 (wide middle-right): her memory appears as a HARD-EDGED, desaturated BACKGROUND FRAGMENT "
  ...
  "NOT at the memory.\n"
  "PANEL 4 (medium middle-left): the present-day blond teen in profile, impassive under the "
  "attention. The kunoichi and the masked man are BLURRED on opposite sides behind him.\n"
  "PANEL 5 (medium lower-right): she faces the whole group now. The dark-haired teen watches her "
  "with a neutral, assessing expression; the white-haired man no longer crowds the frame.\n"
  "PANEL 6 (wide lower-left): she turns specifically to the masked man. He is at frame LEFT and the "
