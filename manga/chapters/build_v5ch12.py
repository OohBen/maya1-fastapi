...
ATTEND = ("other seated clan heads on the east arc, plus faceless attendants and two masked door "
          ...
          "them ever speaking")
MAP = ("THE CHAMBER MAP IS FIXED AND IS NEVER MIRRORED: ONE CONTINUOUS OVAL TABLE, never a "
       "horseshoe and never an open centre. The blonde woman in the green haori sits alone at the "
       "NORTH head, one shallow step above the table, facing south-southeast. The three elderly "
       "advisers occupy the WEST arc at reader-LEFT and look screen-right or south-east. The clan "
       "heads occupy the EAST arc at reader-RIGHT and look screen-left or south. The carved Uchiha "
       "chair stands at the near SOUTHEAST end of the oval, reader-right of the south entrance; "
       "the blond teen sits in it facing north-west. The dark-haired teen stands one pace behind "
       "his right shoulder, between the chair and the south wall, and never crosses behind him. "
       "Nobody enters the interior of the oval. ")
...
PAGES = [
 ...
 ("p01", dict(scene="establishing", light="day", cast="crowd", mood="tense", panels=5),
  ...
  + DAN.format(i=4) + KOHARU.format(i=5) + HOMURA.format(i=6) + ENV.format(i=7)
  + ONLY(BOY16, SAS16, TSU, HAWK, KOH, HOM, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_OFF +
  ...
  R("naruto_v4_black", "sasuke_16", "tsunade", "danzo", "koharu", "homura",
 ...
 ("p02", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=5),
  ...
  + HOMURA.format(i=4) + TSUNADE.format(i=5) + ENV.format(i=6)
  + ONLY(BOY16, SAS16, KOH, HOM, TSU, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_OFF +
  ...
  R("naruto_v4_black", "sasuke_16", "koharu", "homura", "tsunade",
 ...
 ("p03", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=6),
  ...
  + ONLY(BOY16, SAS16, HAWK, KOH, HIA, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_OFF +
 ...
 ("p04", dict(scene="dialogue", light="day", cast="small_group", mood="tense", panels=6),
  FILL + RTL + KOHARU.format(i=1) + TSUNADE.format(i=2) + N16_BLACK.format(i=3) + ENV.format(i=4)
  + ONLY(KOH, TSU, BOY16, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N +
  ...
  R("koharu", "tsunade", "naruto_v4_black", "env_konoha_council_chamber"), "low"),
 ...
 ("p05", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=6),
  ...
  + ONLY(HAWK, HOM, BOY16, SHIK, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N +
  ...
  R("danzo", "homura", "naruto_v4_black", "shikaku", "env_konoha_council_chamber"), "low"),
 ...
 ("p06", dict(scene="dialogue", light="day", cast="crowd", mood="tense", panels=6),
  ...
  + N16_BLACK.format(i=5) + TSUNADE.format(i=6) + SASUKE16.format(i=7) + ENV.format(i=8)
  + ONLY(HAWK, SHIK, KOH, HOM, BOY16, TSU, SAS16, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N
  + EYES_S_OFF +
 ...
 ("p07", dict(scene="dialogue", light="day", cast="small_group", mood="tense", panels=6),
  ...
  + DAN.format(i=4) + ENV.format(i=5)
  + ONLY(HOM, SAS16, BOY16, HAWK, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_OFF +
  ...
  R("homura", "sasuke_16", "naruto_v4_black", "danzo", "env_konoha_council_chamber"), "low"),
 ...
 ("p08", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=6),
  ...
  + TSUNADE.format(i=4) + SHIKAKU.format(i=5) + HIASHI.format(i=6) + ENV.format(i=7)
  + ONLY(HAWK, BOY16, KOH, TSU, SHIK, HIA, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N +
  ...
  R("danzo", "naruto_v4_black", "koharu", "tsunade", "shikaku", "hiashi",
    "env_konoha_council_chamber"), "low"),
 ...
 ("p09", dict(scene="dialogue", light="day", cast="crowd", mood="tense", panels=5),
  ...
  + ONLY(HAWK, HIA, BOY16, SAS16, TSU,
         "the two other elderly advisers on the west arc, seen from behind or in lost profile and "
         "never individually recognisable", ATTEND)
  + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_OFF +
 ...
 ("p10", dict(scene="emotional_closeup", light="day", cast="small_group", mood="tense", panels=3),
  ...
  R("danzo", "homura", "naruto_v4_black", "sasuke_16", "env_konoha_council_chamber"), "high"),

 # ---- Spread 6: attachments --------------------------------------------------------
 ("p11", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=5),
  FILL + RTL + N16_BLACK.format(i=1) + SASUKE16.format(i=2) + HOMURA.format(i=3) + ENV.format(i=4)
  + ONLY(BOY16, SAS16, HOM, EAST_HAND_D, EAST_GLASS_D, ATTEND)
  + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_ON +
  ...
  R("naruto_v4_black", "sasuke_16", "homura", "env_konoha_council_chamber"), "low"),
 ...
 ("p12", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=4),
  ...
  + ONLY(HIA, BOY16, HAWK, TSU, SAS16, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_ON +
 ...
 ("p14", dict(scene="dialogue", light="day", cast="two", mood="tense", panels=4),
  FILL + RTL + TSUNADE.format(i=1) + N16_BLACK.format(i=2) + ENV.format(i=3)
  + ONLY(TSU, BOY16, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N +
  ...
  R("tsunade", "naruto_v4_black", "env_konoha_council_chamber"), "low"),
 ...
 ("p16", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=4),
  ...
  + SASUKE16.format(i=4) + ENV.format(i=5)
  + ONLY(HAWK, BOY16, HOM, SAS16, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_ON +
  ...
  R("danzo", "naruto_v4_black", "homura", "sasuke_16", "env_konoha_council_chamber"), "low"),

 # ---- Spread 9: Sasuke's family ----------------------------------------------------
 ("p17", dict(scene="dialogue", light="day", cast="small_group", mood="tense", panels=4),
  FILL + RTL + N16_BLACK.format(i=1) + SASUKE16.format(i=2) + DAN.format(i=3) + ENV.format(i=4)
  ...
  R("naruto_v4_black", "sasuke_16", "danzo", "env_konoha_council_chamber"), "medium"),
 ...
 ("p18", dict(scene="dialogue", light="day", cast="group", mood="tense", panels=4),
  ...
  + KOHARU.format(i=4) + HOMURA.format(i=5) + DAN.format(i=6) + ENV.format(i=7)
  + ONLY(HIA, SAS16, BOY16, KOH, HOM, HAWK, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N + EYES_S_ON +
  ...
  R("hiashi", "sasuke_16", "naruto_v4_black", "koharu", "homura", "danzo",
    "env_konoha_council_chamber"), "low"),
 ...
 ("p20", dict(scene="dialogue", light="day", cast="crowd", mood="calm", panels=3),
  ...
  + ONLY(HAWK, SAS16, TSU, BOY16, KOH, HOM, ATTEND) + MAP + DOCS + BLACKFIT + EYES_N +
