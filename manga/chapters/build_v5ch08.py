...
PAGES = [
 ...
 ("p01", dict(scene="establishing", light="day", cast="two", mood="calm", panels=5),
  ...
  "PANEL 3 (middle row, left): medium profile two-shot — the teen at the LEFT still moving left, "
  "the creature one pace behind at the RIGHT with its face turned back toward the base. The "
  "teen's mouth is visible.\n"
  "PANEL 4 (middle row, right): the creature closes the gap and turns its head toward the teen; "
 ...
 ("p07", dict(scene="dialogue", light="day", cast="two", mood="somber", panels=6),
  ...
  "PANEL 3 (narrow panel beside it): he straightens but keeps one pace of distance. His "
 ...
 ("p09", dict(scene="establishing", light="interior", cast="solo", mood="tense", panels=7),
  ...
  "PANEL 3 (narrow panel beside it): close on the teen's active red six-bladed left eye — a flat "
 ...
 ("p11", dict(scene="action", light="white_void", cast="two", mood="tense", panels=6),
  ...
  "PANEL 4 (tall restraint panel, middle right): the four copies pull away and vanish, leaving "
 ...
 ("p14", dict(scene="dialogue", light="interior", cast="two", mood="somber", panels=7),
  ...
  "PANEL 4 (central BORDERLESS memory image, softly faded at its edges): a gentle-faced "
 ...
 ("p15", dict(scene="dialogue", light="interior", cast="two", mood="tense", panels=6),
  ...
  "visible.\n"
  "PANEL 2 (top left): close on her, suspicious. Her mouth is visible.\n"
  ...
  "PANEL 6 (large panel across the bottom): he stands outside the RIGHT edge of the desk; she "
 ...
 ("p17", dict(scene="dialogue", light="interior", cast="two", mood="calm", panels=7),
  ...
  "panel.\n"
  "PANEL 3 (tight insert beside it): smoke bursts from the tattoo as a flat opaque shape and a "
