...
PAGES = [
 ...
 ("p12", dict(scene="emotional_closeup", light="white_void", cast="two", mood="somber", panels=7),
  ...
  "only — no injury detail, no blood, no gore, no wounds and no red fluid anywhere. This "
  "applies to EVERY shard including the throne-hall shard: the four dead lie intact and "
  "unmarked, with clean clothing and clean stone around them, and NOTHING red, wet, pooled "
  "or spattered appears on any body, floor, wall or object.\n"
 ...
 ("p13", dict(scene="action", light="interior", cast="two", mood="tense", panels=6),
  ...
  "PANEL 4 (lower tier, RIGHT — ONE ordinary rectangular frame occupying the right third of that "
  "tier, never split, never divided by an internal border, and never repeated as a second "
  "frame anywhere on the page): the pressure is gone and papers settle. She coughs once, plants "
  "one boot and begins pushing herself up in that single frame; he has not moved.\n"
  "PANEL 5 (lower tier, CENTRE — directly to the LEFT of panel 4 on the same tier, read after "
  "it): she stands using the desk edge, breathing hard but meeting his eyes. "
