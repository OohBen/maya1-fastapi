...
PAGES = [
 ...
 ("p04", dict(scene="dialogue", light="day", cast="two", mood="tense", panels=6),
  ...
  "PANEL 4 (medium on the blond teen, middle left — an ordinary rectangle inside the middle tier, "
  "the same height as PANEL 3 and never a tall panel spanning two tiers): he turns his face toward her but keeps "
 ...
 ("p09", dict(scene="dialogue", light="day", cast="two", mood="calm", panels=7),
  ...
  "PANEL 4 (medium on the red-haired girl, middle left — an ordinary rectangle inside the middle "
  "tier, the same height as PANEL 3 and never a tall panel spanning two or three tiers): she does "
  "not pick the key up yet.\n"
 ...
 ("p12", dict(scene="dialogue", light="overcast", cast="small_group", mood="calm", panels=7),
  ...
  "PANEL 5 (close on the blond teen, middle left, the focal panel — it earns that by being the "
  "WIDEST panel of the middle tier, NOT by being tall: it stays inside that tier and never spans "
  "down beside the panels below): a small smile, held inside "
